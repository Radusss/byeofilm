...
//       : `Avg last hour: ${average}\n\nNo present infection. You are doing good!`;
...
//       </View>
//       <View style={styles.spacing}>
//         <HealthyTip text="Remember to stay active and eat healthy!" />
//       </View>
//       <View style={styles.spacing}>
//         <DoctorButton
//           logoSource={require("./../assets/images/stethoscope.png")} // Use require for the local image
